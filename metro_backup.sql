...
CREATE TABLE `passengers` (
  ...
  `media_uid` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `passengers` VALUES (1,'Med','med123@gmail.com','0123456789','$2y$12$mb50sjsWirSZEead2RcRfujj7bB0lHmLWwQuoWUGTyBaJiJ0eNesa',NULL,NULL,NULL,NULL);
...
INSERT INTO `ticket_types` VALUES (1,'Single Trip','رحلة واحدة',50.00,1,24,'2026-02-20 15:24:44','2026-02-20 15:24:44');
...
CREATE TABLE `tickets` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `ticket_uuid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ticket_payload` longtext COLLATE utf8mb4_unicode_ci,
  ...
  `last_gate_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `trips` (
  ...
  `entry_station` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `entry_time` timestamp NULL DEFAULT NULL,
  `gate_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2026-03-06 23:08:08
